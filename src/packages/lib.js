(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === "object" && typeof module === "object") module.exports = factory(require("three"), require("three-csg-ts"), require("suncalc"));
  else if (typeof define === "function" && define.amd) define(["three", "three-csg-ts", "suncalc"], factory);
  else if (typeof exports === "object") exports["huyong3d"] = factory(require("three"), require("three-csg-ts"), require("suncalc"));
  else root["huyong3d"] = factory(root["three"], root["three-csg-ts"], root["suncalc"]);
    ...
    /******/ var __webpack_modules__ = [
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        (function (global, factory) {
          if (true) {
            !((__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(71)]),
...
*/
      ...
      /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (dom) => {
          ...
          //创建相机
          const camera = (() => {
            const _m = new three__WEBPACK_IMPORTED_MODULE_0__.PerspectiveCamera(
              _config__WEBPACK_IMPORTED_MODULE_4__.FOV,
              parentConf.width / parentConf.height,
              _config__WEBPACK_IMPORTED_MODULE_4__.NEAR,
              _config__WEBPACK_IMPORTED_MODULE_4__.FAR
            );
          ...
          const hemisphereLight = (function () {
            const _m = new three__WEBPACK_IMPORTED_MODULE_0__.HemisphereLight(
              _config__WEBPACK_IMPORTED_MODULE_4__.HEMISPHERE_CONF.SC,
              _config__WEBPACK_IMPORTED_MODULE_4__.HEMISPHERE_CONF.EC,
              _config__WEBPACK_IMPORTED_MODULE_4__.HEMISPHERE_CONF.I
            );
        ...
        class Cube {
          ...
          createHouse(a, b) {
            return new three__WEBPACK_IMPORTED_MODULE_0__.Mesh(
              new three__WEBPACK_IMPORTED_MODULE_0__.BoxGeometry(a, this.config.h, b),
              new three__WEBPACK_IMPORTED_MODULE_0__.MeshBasicMaterial({ color: new three__WEBPACK_IMPORTED_MODULE_0__.Color(this.config.c) })
            );
          }
          createEave(a, b) {
            const mesh = new three__WEBPACK_IMPORTED_MODULE_0__.Mesh(
              new three__WEBPACK_IMPORTED_MODULE_0__.BoxGeometry(a, this.config.eave_h, b),
              new three__WEBPACK_IMPORTED_MODULE_0__.MeshStandardMaterial({ depthTest: false, color: this.config.eave_c })
            );
      ...
      /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        class Support {
          ...
          createBoard() {
            ...
            const mesh = new three__WEBPACK_IMPORTED_MODULE_0__.Mesh(
              new three__WEBPACK_IMPORTED_MODULE_0__.BoxGeometry(this.compData.w, h, this.compData.l),
              new three__WEBPACK_IMPORTED_MODULE_0__.MeshBasicMaterial({ color: 0xdddddd })
            );
          ...
          createCylinder() {
            ...
            const cylinder = new three__WEBPACK_IMPORTED_MODULE_0__.Mesh(
              new three__WEBPACK_IMPORTED_MODULE_0__.CylinderGeometry(Support.CYLINER.W, Support.CYLINER.H, _height, 3),
              new three__WEBPACK_IMPORTED_MODULE_0__.MeshStandardMaterial({ color: 0xcccccc, roughness: 0.5, metalness: 0.5 })
            );
        ...
        class Component {
          ...
          constructor(data, manager) {
            ...
            const mesh = new three__WEBPACK_IMPORTED_MODULE_0__.Mesh(
              new three__WEBPACK_IMPORTED_MODULE_0__.BoxGeometry(this.data.w, this.data.h, this.data.l),
              new three__WEBPACK_IMPORTED_MODULE_0__.MeshStandardMaterial({ map: texture, metalness: 0.7, roughness: 0.7 })
            );
      ...
      /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        class Ground {
          ...
          createPlace() {
            ...
            const mesh = new three__WEBPACK_IMPORTED_MODULE_0__.Mesh(
              new three__WEBPACK_IMPORTED_MODULE_0__.PlaneGeometry(size, size),
              new three__WEBPACK_IMPORTED_MODULE_0__.MeshStandardMaterial({ color: 0xbababa, side: three__WEBPACK_IMPORTED_MODULE_0__.DoubleSide })
            );
      ...
      /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        class Sun {
          ...
          createSun() {
            return new three__WEBPACK_IMPORTED_MODULE_0__.Mesh(
              new three__WEBPACK_IMPORTED_MODULE_0__.IcosahedronGeometry(0.2, 2),
              new three__WEBPACK_IMPORTED_MODULE_0__.MeshBasicMaterial({ color: 0xffc900 })
            );
          }
          createLight() {
      ...
      /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        class Base {
          ...
          cylinder(houseData) {
            const r = this.w / 2;
            const mesh = new three__WEBPACK_IMPORTED_MODULE_0__.Mesh(new three__WEBPACK_IMPORTED_MODULE_0__.CylinderGeometry(r, r, this.h, 32), [
              new three__WEBPACK_IMPORTED_MODULE_0__.MeshStandardMaterial({ color: 0x999999 }),
              new three__WEBPACK_IMPORTED_MODULE_0__.MeshStandardMaterial({ color: 0x999999 }),
            ]);
            const positionY = this.data.isRoofInside ? houseData.h / 2 + this.h / 2 : houseData.h / -2 + this.h / 2;
            mesh.position.y = positionY;
        ...
        class Type1 extends Base {
          ...
          createTop() {
            ...
            const mesh = new three__WEBPACK_IMPORTED_MODULE_0__.Mesh(
              new three__WEBPACK_IMPORTED_MODULE_0__.CylinderGeometry(r, r, h, 32),
              new three__WEBPACK_IMPORTED_MODULE_0__.MeshStandardMaterial({ color: 0xffffff, metalness: 0.5, roughness: 0.5 })
            );
          ...
          createComponent(v) {
            ...
            const mesh = new three__WEBPACK_IMPORTED_MODULE_0__.Mesh(
              new three__WEBPACK_IMPORTED_MODULE_0__.PlaneGeometry(this.w, Math.abs(this.h / Math.cos(r))),
        ...
        class Type3 extends Base {
          ...
          createLeaf() {
            ...
            const group = new three__WEBPACK_IMPORTED_MODULE_0__.Group();
            for (let i = 0; i < len; i++) {
              const m = new three__WEBPACK_IMPORTED_MODULE_0__.Mesh(
                new three__WEBPACK_IMPORTED_MODULE_0__.ConeGeometry((this.w / len) * (((i + 1) / len) * 2 + 1), Type3.LEAF.H, Type3.LEAF.S),
                new three__WEBPACK_IMPORTED_MODULE_0__.MeshLambertMaterial({ color: 0x00721a })
              );
          ...
          createMain(houseData) {
            const tree = new three__WEBPACK_IMPORTED_MODULE_0__.Mesh(
              new three__WEBPACK_IMPORTED_MODULE_0__.CylinderGeometry(this.w, this.l, this.h, 32),
          ...
          constructor(data, houseData) {
            ...
            const tree = new three__WEBPACK_IMPORTED_MODULE_0__.Mesh(
              new three__WEBPACK_IMPORTED_MODULE_0__.CylinderGeometry(0.02, 0.02, this.h, 32),
              new three__WEBPACK_IMPORTED_MODULE_0__.MeshBasicMaterial({ color: 0x6a4d00 })
            );
        ...
        class Type4 extends Base {
          ...
          createPoles(n) {
            ...
            for (let i = 0; i < n; i++) {
              const m = new three__WEBPACK_IMPORTED_MODULE_0__.Mesh(
                new three__WEBPACK_IMPORTED_MODULE_0__.CylinderGeometry(r, r, w, 8),
                new three__WEBPACK_IMPORTED_MODULE_0__.MeshPhysicalMaterial({ color: 0x999999 })
              );
        ...
        class Type5 extends Base {
          ...
          constructor(data, houseData) {
            super(data);
            const mesh = this.createModel(houseData);
            const plane = new three__WEBPACK_IMPORTED_MODULE_0__.Mesh(
              new three__WEBPACK_IMPORTED_MODULE_0__.PlaneGeometry(0.08, Math.min(this.h, 0.12) * 0.9),
              new three__WEBPACK_IMPORTED_MODULE_0__.MeshBasicMaterial({
                side: three__WEBPACK_IMPORTED_MODULE_0__.DoubleSide,
                map: new three__WEBPACK_IMPORTED_MODULE_0__.TextureLoader().load("textures/window.jpg"),
              })
            );
            ...
            const door = new three__WEBPACK_IMPORTED_MODULE_0__.Mesh(
              new three__WEBPACK_IMPORTED_MODULE_0__.PlaneGeometry(doorHeight, doorWidth),
              new three__WEBPACK_IMPORTED_MODULE_0__.MeshBasicMaterial({ side: three__WEBPACK_IMPORTED_MODULE_0__.DoubleSide, color: 0x000000 })
            );
        ...
        class Type9 extends Base {
          ...
          createRoof() {
            const create = () => {
              ...
              const m = new three__WEBPACK_IMPORTED_MODULE_0__.Mesh(
                new three__WEBPACK_IMPORTED_MODULE_0__.CylinderGeometry(this.l * scale, this.l * scale, this.w, 6),
                new three__WEBPACK_IMPORTED_MODULE_0__.MeshBasicMaterial({ color: 0xffff00 })
              );
              m.rotation.x = (Math.PI / 180) * -90;
          ...
          constructor(data, houseData) {
            super(data);
            const mesh = new three__WEBPACK_IMPORTED_MODULE_0__.Mesh(
              new three__WEBPACK_IMPORTED_MODULE_0__.BoxGeometry(this.w, this.h, this.l),
              new three__WEBPACK_IMPORTED_MODULE_0__.MeshStandardMaterial({ color: 0xeddac5 })
            );
            const positionY = this.$data.isRoofInside ? houseData.h / 2 + this.h / 2 : houseData.h / -2 + this.h / 2;
      ...
      /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        class Support {
          ...
          constructor(houseIns, data) {
            ...
            this.data.forEach((d) => {
              const mesh = this.createCylinder(
                d.coordinate.x / _config__WEBPACK_IMPORTED_MODULE_1__.NUMERATOR,
                d.coordinate.y / _config__WEBPACK_IMPORTED_MODULE_1__.NUMERATOR,
                d.height / _config__WEBPACK_IMPORTED_MODULE_1__.NUMERATOR
              );
              this.group.add(mesh);
            });
          }
          ...
          createCylinder(x, z, height) {
            const cylinder = new three__WEBPACK_IMPORTED_MODULE_0__.Mesh(
              new three__WEBPACK_IMPORTED_MODULE_0__.CylinderGeometry(0.01, 0.01, height, 3),
              new three__WEBPACK_IMPORTED_MODULE_0__.MeshStandardMaterial({ color: 0xcccccc, roughness: 0.5, metalness: 0.5 })
            );
            cylinder.position.x = x - this.houseIns.$data.l / 2;
            cylinder.position.z = z - this.houseIns.$data.w / 2;
            cylinder.position.y = height / 2 + this.houseIns.$data.h / 2 + _config__WEBPACK_IMPORTED_MODULE_1__.EAVE.H;
            cylinder.castShadow = true;
            return cylinder;
          }
        }
